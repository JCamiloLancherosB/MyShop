...
const creaTd = (elementos, fragmento) => {
    ...
    img1.setAttribute("src", "./Imagenes/expandir2.png");
    img1.setAttribute("title", "View");
    img2.setAttribute("src", "./Imagenes/details.png");
    img2.setAttribute("title", "View Details");
    img3.setAttribute("src", "./Imagenes/carrito2.png");
    img3.setAttribute("title", "Add to cart");
    img4.setAttribute("src", "./Imagenes/favorite.png");
    ...
    boton4.addEventListener("mouseover", function(e){img4.src = "./Imagenes/favorite3.png"});
    boton4.addEventListener("mouseout", function(e){img4.src = "./Imagenes/favorite.png"});
...
const productos = (dato) => {
    ...
    // const img = document.createElement("img");
    // img.setAttribute("src", "./Imagenes/desIzq.png");
    ...
    //<td class="des"><button class="desDer"><img src="./Imagenes/desIzq.png"></button></td>
};
...
document.addEventListener("click", function(e){
    ...
    // const imagenes = document.querySelectorAll("#opac img");
...
// // const img1 = new Boton("", "", "./Imagenes/cursor2.png", "", "1px solid black"); //ESTO FUNCIONA //Los parametro se van adjuntando a la clase en orden en que se ponga sobre la nueva instanacia, si quiero poner
...
// const boton2 = new Boton("blue", "larger", "url('./Imagenes/cursor2.png')", "no-repeat", "1px solid black", "", "200px", "200px", "0px", "50%");
...
btn1.creaUnBoton(document.body);
...
//7800 entre 3 para dos panes de 4k, 7800 dividido entre 3 da 2.6k, y como se compraron dos de 3k sobraron 1.8k que 2k dividido entre 3 da de a 700 para dos, y 600paraelotrocasocerrado.PUT0 sin contar 200 de Mamanuel